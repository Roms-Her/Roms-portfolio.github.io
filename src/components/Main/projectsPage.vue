   ...
   <div id="modal" v-if="modalVisible"
      ...
      <div class="flex flex-col items-center p-8 overflow-y-auto h-full">
        ...
        <div class="flex flex-col items-center justify-center">
          ...
          <a v-if="selectedProject.link" :href="selectedProject.link" class="text-sm uppercase font-bold text-solid" target="_blank" >Cliquez ici pour visiter le site web !</a>
        </div>
      </div>
</div>
  </section>
